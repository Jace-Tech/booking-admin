...
export const DELETE_BUS_ENDPOINT = BASE_URL + "/bus/:id"
export const UPDATE_BUS_ENDPOINT = BASE_URL + "/bus/:id"
...
export const UPDATE_ROUTE_ENDPOINT = BASE_URL + "/route/:id"
...
export const UPDATE_TERMINAL_ENDPOINT = BASE_URL + "/terminal/:id"
